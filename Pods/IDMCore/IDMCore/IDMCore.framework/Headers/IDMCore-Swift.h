...
/// Default initializer. Integration will use this for create its DataLayer. Override this method to custom sub layers & configurations.
///
...
///
/// \param dataReturnedBySubLayers array of data return by sub layers requests
- (NSDictionary<NSString *, id> * _Nullable)compoundData:(NSArray<NSDictionary<NSString *, id> *> * _Nonnull)dataReturnedBySubLayers;

/// Override this method to specific parameters for sub layer from parameters of compound layer. Only need when interdependence = false
///
/// \param index index of sub layer
///
/// \param compoundParameters parameters of compound layer
///
/// \returns  parameters for sub layer
- (NSDictionary<NSString *, id> * _Nullable)parametersForSubLayerAtIndex:(NSInteger)index compoundParameters:(NSDictionary<NSString *, id> * _Nullable)compoundParameters;
@end
